...
class Ion_auth
{
	...
	public function __construct()
	{
		...
		define("VERSION", '2.2');
                define("TOWORDS", $SETTING->display_words);
		...
		if(get_cookie('inv_language')) {
			if(file_exists('sim/language/'.get_cookie('inv_language').'/inv_lang.php') && is_dir('sim/language/'.get_cookie('inv_language'))) {
			$this->lang->load('inv', get_cookie('inv_language'));
			define("LANGUAGE", get_cookie('inv_language'));
			}
		} else {
			$this->lang->load('inv', $SETTING->language);
