  ...
  */
  class Alerts
  {
    ...
    */
	...
	public function query($query, $backtick_protect = TRUE)
    {

      $this->ci->db->query($query, $backtick_protect);
      return $this;
    }
    ...
    */
    protected function produce_output($charset)
    {
      ...
      $iFilteredTotal = $this->get_total_results();
    ...
    */
    public function get_total_results($filtering = FALSE)
    {
	  ...
	  */
	  ...
	  $this->ci->db
			->select('products.id as productid, products.image as image, products.code as code, products.name, products.unit, products.price, (CASE WHEN sum(warehouses_products.quantity) Is Null THEN 0 ELSE sum(warehouses_products.quantity) END) as totalQuantity, products.alert_quantity as alertQuantity', FALSE)
			->from('products')
