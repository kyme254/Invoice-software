		...
		function status(x) {
			...
			function format_date(oObj) {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=reports&view=getsales<?php if($this->input->post('submit')) { echo $v; } ?>',
...
<?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=reports&view=sales"); ?>
<div class="form-group">
  <label for="product"><?php echo $this->lang->line("product"); ?></label>
  <div class="controls"> <?php echo form_input('product', (isset($_POST['product']) ? $_POST['product'] : ""), 'class="form-control" id="product"');?> </div>
</div>
<div class="row">
    <div class="col-md-6">
<div class="form-group">
  ...
  <div class="controls">
    <?php 
			$st = array(
				...
				$this->lang->line('partially_paid')		=> $this->lang->line('partially_paid'),
