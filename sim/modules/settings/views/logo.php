...
<div class="matter">
  <div class="container">
    <?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("module=settings&view=change_logo");?>
    <div class="fprm-group">
      <label class="control-label" for="copy"><?php echo $this->lang->line("upload_logo"); ?></label>
      <div class="controls">
        ...
        <span class="help-block"><?php echo $this->lang->line("site_logo_tip"); ?></span> </div>
    </div>
