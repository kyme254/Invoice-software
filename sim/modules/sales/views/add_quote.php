...
$(document).ready(function(){
	...
	newTr.html('<td style="width: 20px; text-align: center; padding-right: 10px;">'+ counter +'</td><td><input type="text" class="form-control" name="quantity' + counter + 
	      ...
	      '" id="product' + counter + '" value="" class="form-control" /></td><td><select class="form-control" style="min-width: 100px;" name="tax_rate' + counter + '" id="tax_rate' + counter + '"><?php
...
<div class="matter">
  <div class="container">
    <?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=sales&view=add_quote");?>
    <div class="row">
      <div class="col-md-5"> 
  ...
  <div class="controls"> <?php 
        ...
        <div class="form-group">
          ...
          <div class="controls">
			...
			echo form_dropdown('customer', $cu, (isset($_POST['customer']) ? $_POST['customer'] : ""), 'class="form-control" data-placeholder="'.$this->lang->line("select")." ".$this->lang->line("customer").'" id="customer"');  ?>
          </div>
        </div>
    ...
    <div class="form-group"> <?php echo form_submit('submit', $this->lang->line("add_quote"), 'class="btn btn-primary btn-large"');?> </div>
    <?php echo form_close();?>
    <div class="clearfix"></div>
  </div>
  <div class="clearfix"></div>
