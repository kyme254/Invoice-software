...
<body>
<div id="wrap">
<img src="<?php echo $this->config->base_url(); ?>assets/img/<?php echo INVOICE_LOGO; ?>" alt="SITE_NAME" />
<div class="row-fluid">    
<div class="span6">
...
<p style="font-weight:bold;"><?php echo $this->lang->line("date"); ?>: <?php echo date(PHP_DATE, strtotime($inv->date)); ?></p>
   ...
   <div style="clear: both;"></div>
    ...
    <?php 
		...
		endforeach;
	?>
<!--<tr><td colspan="6" style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo $this->lang->line("total"); ?> (<?php echo CURRENCY_PREFIX; ?>)</td><td style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo $inv->inv_total; ?></td></tr>
<tr><td colspan="6" style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo $this->lang->line("tax"); ?> (<?php echo CURRENCY_PREFIX; ?>)</td><td style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo $inv->total_tax; ?></td></tr>
...
<?php } ?>
<tr class="info"><td colspan="4"><?php if (($inv->total+$inv->shipping) != 0) { list($no, $fr) = explode(".", (number_format(($inv->total+$inv->shipping), 2, '.', ''))); echo ucfirst(Numbers_Words::toWords($no))." ".CMAJOR; if($fr!=0) { echo " & ". Numbers_Words::toWords($fr) ." ".CMINOR; } } ?></td><td colspan="2" style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo $this->lang->line("grand_total"); ?> (<?php echo CURRENCY_PREFIX; ?>)</td><td style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo number_format(($inv->total+$inv->shipping), 2, '.', ''); ?></td></tr>-->
...
<td colspan="2" style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo $this->lang->line("quote_total"); ?> (<?php echo CURRENCY_PREFIX; ?>)</td>
...
<?php if ($inv->total_discount != 0) { ?>
<tr>
<td colspan="6" style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo $this->lang->line("quote_total"); ?> (<?php echo CURRENCY_PREFIX; ?>)</td>
<td style="text-align:right; padding-right:20px; font-weight:bold;"><?php echo number_format(($inv->total+$inv->shipping+$inv->total_discount), 2, '.', ''); ?></td></tr>
