...
<div class="matter">
  <div class="container">
    <?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=sales&view=edit_quote&id=".$id);?>
    <div class="row">
      <div class="col-md-5">
    ...
    <div class="form-group"> <?php echo form_submit('submit', $this->lang->line("update_quote"), 'class="btn btn-primary btn-large"');?> </div>
    <?php echo form_close();?>
    <div class="clearfix"></div>
  </div>
  <div class="clearfix"></div>
