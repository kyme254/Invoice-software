...
<div class="matter">
  <div class="container">
    <?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=sales&view=edit&id=".$id);?>
    <div class="row">
    <div class="col-md-5">
    ...
    <div class="form-group">
      ...
      <div class="controls">
        <?php 
			...
			echo form_dropdown('status', $st, $inv->status, 'class="status form-control" data-placeholder="'.$this->lang->line("select")." ".$this->lang->line("status").'" id="status"');  ?>
      </div>
    </div>
    ...
    <?php if($inv->status != $this->lang->line('paid') && $inv->status != $this->lang->line('cancelled')) { ?>
    <a class="btn btn-success btn-lg">Add Payment </a>
    <?php } ?>
    </div>-->
    </div>
    <table id="dyTable" class="table table-striped" style="margin-bottom:5px;">
      ...
      <tbody>
        ...
        <tr id="line<?php echo $r; ?>">
          ...
          <td><?php echo form_input('quantity'.$r, $prod->quantity, 'id="quantity0'.$r.'" class="form-control input-sm" style="min-width: 70px; text-align: center;"');?></td>
          <td><?php echo form_input('product'.$r, $prod->product_name, 'id="product0'.$r.'" class="form-control input-sm" style="min-width: 270px;"'); ?></td>
          <td><?php echo form_dropdown('tax_rate'.$r, $tr, $prod->tax_rate_id, 'id="tax_rate0'.$r.'" class="form-control input-sm" style="min-width: 100px;"');  ?></td>
          <td><?php echo form_input('unit_price'.$r, $prod->unit_price, 'id="price-0'.$r.'" class="form-control input-sm text-right" style="min-width: 100px;"'); ?></td>
        ...
        <tr id="line<?php echo $rw; ?>">
          ...
          <td><?php echo form_input('quantity'.$rw, '', 'id="quantity0'.$rw.'" class="form-control input-sm" style="min-width: 70px; text-align: center;"');?></td>
          <td><?php echo form_input('product'.$rw, '', 'id="product0'.$rw.'" class="form-control input-sm" style="min-width: 270px;"'); ?></td>
          <td><?php echo form_dropdown('tax_rate'.$rw, $tr, DEFAULT_TAX, 'id="tax_rate0'.$rw.'" class="form-control input-sm" style="min-width: 100px;"');  ?></td>
          <td><?php echo form_input('unit_price'.$rw, '', 'id="price-0'.$rw.'" class="form-control input-sm text-right" style="min-width: 100px;"'); ?></td>
        </tr>
        <?php } 
			} ?>
      </tbody>
    ...
    <div class="form-group"> <?php echo form_submit('submit', $this->lang->line("update_sale"), 'class="btn btn-primary btn-large"');?> </div>
    <?php echo form_close();?>
    <div class="clearfix"></div>
  </div>
  <div class="clearfix"></div>
