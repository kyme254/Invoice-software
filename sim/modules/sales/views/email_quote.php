...
<div class="matter">
  <div class="container"> 
    ...
    <?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=sales&view=email_quote&id=".$id); ?>
...
<div class="form-group">
  ...
  <div class="controls"> <?php if($id) { $txt = $this->lang->line("quote")." ".$this->lang->line("no")." ".$id; } ?>
